...
using Microsoft.Data.SqlClient;
using System.Data;
using System.ComponentModel; // Add this namespace for DesignMode check
...
namespace POS_project
{
    internal class ProductData
    {
        ...
        // Helper method to check if running in design mode
        ...
        public List<ProductData> AllProductData()
        {
            ...
            if (IsInDesignMode())
            {
                // Return an empty list or some dummy data for the designer
                return listdata;
            }

            // Your existing database connection and data retrieval logic
